...
class DigitalLibrary {
    ...
    static String adminId = "Anirban0";
    static String adminPass = "Sarkar123";
        ...
        while (true) {
            ...
            if (ch == 1) {
                ...
                if (books.containsKey(id)) {
                    ...
                    System.out.println("✅ Successful: Updated Book");
                ...
                viewBooks();
                System.out.println("✅ Successful: Viewed Books");
            } else break;
        }
    }
    ...
    static void userMenu() {
        while (true) {
            ...
            if (ch == 1) {
                ...
                if (!found) {
                    System.out.println("❌ Sorry, this book is not available now");
                } else {
                    System.out.println("✅ Successful: Searched Book");
                }
            } else if (ch == 3) {
                ...
                if (books.containsKey(id)) {
                    ...
                    System.out.println("✅ Successful: Issued Book");
                } else System.out.println("Book not found");
            } else if (ch == 4) {
